<template>
  <div>
    <ul class="mt-3 grid grid-cols-1 gap-5 sm:gap-6 sm:grid-cols-2 lg:grid-cols-4">
      <li v-if="getIsBefore8pm()" class="col-span-1 flex shadow-sm rounded-md">
        ...
        <div class="flex-1 flex items-center justify-between border-t border-r border-b border-gray-200 bg-white rounded-r-md truncate">
          <div class="flex-1 px-4 py-2 text-lg truncate">
            <a href="#" class="text-gray-900 font-medium hover:text-gray-600">Meals</a>
            <p class="text-gray-500">Today, {{getFormattedToday()}}</p>
          </div>
      ...
      <li v-else class="col-span-1 flex shadow-sm rounded-md">
        ...
        <div class="flex-1 flex items-center justify-between border-t border-r border-b border-gray-200 bg-white rounded-r-md truncate">
          <div class="flex-1 px-4 py-2 text-lg truncate">
            <a href="#" class="text-gray-900 font-medium hover:text-gray-600">Meals</a>
            <p class="text-gray-500">Tomorrow, {{getFormattedTomorrow()}}</p>
          </div>
        </div>
      </li>
    </ul>
...
export default {
  ...
  methods: {
    getIsBefore8pm() {
      ...
      // returning true for anything up till 19:59
    ...
    getFormattedTomorrow() {
      ...
      // ex: May 22
      return `${monthNames[tomorrow.getMonth()]} ${tomorrow.getDate()}`;
    }
  }
};
</script>
